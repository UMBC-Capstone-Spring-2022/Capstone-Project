# -*- coding: utf-8 -*-
"""Mura_streamlit.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1sNh1tsBr8a1StXp_6vM5NJbr0xbntZr5
"""
...
loaded_model_humerus.load_state_dict(torch.load("Humerus_DenseNet161_weights.pth",map_location=torch.device('cpu'))) 
...
loaded_model_elbow.load_state_dict(torch.load("Elbow_re_DenseNet161_weights.pth",map_location=torch.device('cpu'))) 
...
loaded_model_wrist.load_state_dict(torch.load("Wrist_re_DenseNet161_weights.pth",map_location=torch.device('cpu'))) 
